...
function doChange(E)
{
	...
	if( oldArchive == false && archiveMode == true){	// Change to Archive mode
		oldDayIndex =  document.getElementById("Day").options.selectedIndex;
		document.getElementById("Day").options[document.getElementById("Day").options.selectedIndex].selected = false;
		document.getElementById("Day").disabled = true;
	}
	else if (oldArchive == true && archiveMode == false){ // Change to Normal mode
...
function newclick(E)
{
	...
	if(parameter === "") {
		...
		if(infoPopup == "XBL") {
			if(archiveMode){
				addInfo(E.latLng, "<pre>Not available for Archive dates</pre>");
				return;
			}
