...
/* 13 */ ["optionBoldBlue", "sfcsunpct",			"Normalized Sfc. Sun", "The 'Solar Radiation' actually reaching the surface divided by the amount of solar radiation which would reach the surface in a dry atmosphere (i.e. in the absence of clouds and water vapor), expressed as a percentage.  This parameter indicates the degree of cloudiness, i.e. where clouds limit the sunlight reaching the surface."],
...
/* 18 */ ["optionBoldBlue",		 "sfcwind0", 			"Sfc.Wind (2m)", "The speed and direction of the wind 2m above the ground.  Speed is depicted by different colors and direction by streamlines.  This parameter is obtained directly from WRF model output and not from a BLIPMAP computation."],

/* 19 */ ["",		 "sfcwind", 			"Sfc.Wind (10m)", "The speed and direction of the wind at 10m above the ground.  Speed is depicted by different colors and direction by streamlines.  This parameter is obtained directly from WRF model output and not from a BLIPMAP computation."],
...
/* 60 */ ["",		 "topo", 					"Topography", "Topography"],

/* 61 */ ["",		 "stars", 				"Star Rating", "Experimental: Based on \"Thermalling Height\" (hglider). An adjustment for (the boundary layer average) wind speed of 0.25*((Wnd - 15)^2)/Wnd is applied, giving n a reduction of about 1 at 25 kt and 4 at 40 kt. 0.5 is added if CuPotential is between 500 and 5000 (indicates small puffy Cu) and 0.5 deducted if CuPotential is < 0 (blue conditions). The Rating is then modified by the Buoyancy-Shear Ratio (bsratio): -0.9 @ 0; 0 @ 3; +0.9 @ 6 (this will be inappropriate in regions with stronger thermals). Finally, the result is spatially filtered to remove noise."],

/* 62 */ ["",		 "starshg", 				"Star Rating - Foot Launchers", "As Stars Rating but using a different adjustment for wind, using SfcWind(10m) rather than BLAvgWind."]
...
var paramListLite  = [
	...
	paramListFull[56],
	paramListFull[57],
	paramListFull[58]	// Do NOT forget to have "," between each item
	// paramListFull[58],
	// paramListFull[59]	// Last one must NOT have "," or YouKnowWho bombs
];
...
var	GMparamListFull  = [
	...
	paramListFull[14],
	paramListFull[15],
	paramListFull[61],	// NOTE: Out of Order - STARS Rating
	paramListFull[16],
	paramListFull[17],
	paramListFull[18],
	paramListFull[19],
	...
	paramListFull[59],
	paramListFull[60],
	paramListFull[62]	// NOTE: No comma !!!
...
var GMparamListLite  = [
	...
	paramListFull[58],
	paramListFull[59],
	paramListFull[60]	// NOTE: No comma !!!
	// Do NOT forget to have "," between each item
	// Last one must NOT have "," or YouKnowWho bombs
];
